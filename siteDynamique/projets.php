...
<body>
    ...
    <a href="mainIntranet.php">  / Accueil Intranet</a><a href="projets.php">  / Gestion projets </a>
    </div>

    <h2 class="h2Centre">Gestion de projets EN COURS DE TRAVAUX ! ;)</h2>
    ...
    <div class="grid-container">
        ...
        <div class="Recherche">
            <form action ="ressourcesHumaines.php" class="searchForm" method="post">
                <input class="searchInput"  name="search" placeholder= "Rechercher un projet..." required>
